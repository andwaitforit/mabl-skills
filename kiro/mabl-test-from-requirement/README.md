# mabl-test-from-requirement — Kiro skill
...
Shared setup (mabl CLI, `.kiro/settings/mcp.json`) is in [`../README.md`](../README.md). Beyond that:
...
```bash
cp -r mabl-test-from-requirement ~/.kiro/skills/        # or <your-repo>/.kiro/skills/
```
