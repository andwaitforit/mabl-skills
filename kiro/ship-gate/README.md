...
Shared setup (mabl CLI, `.kiro/settings/mcp.json`) is in [`../README.md`](../README.md). This skill needs the **mabl MCP
...
```bash
cp -r ship-gate ~/.kiro/skills/        # or <your-repo>/.kiro/skills/
```
