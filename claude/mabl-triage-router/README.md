# mabl-triage-router — Claude Code skill
...
Shared setup is in the [top-level README](../../README.md). This skill is mostly **pure
...
```bash
cp -r mabl-triage-router ~/.claude/skills/        # or <your-repo>/.claude/skills/
```
