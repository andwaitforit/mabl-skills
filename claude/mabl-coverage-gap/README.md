# mabl-coverage-gap — Claude Code skill
...
Shared setup (mabl CLI, MCP server) is in the [top-level README](../../README.md).
...
```bash
cp -r mabl-coverage-gap ~/.claude/skills/        # or <your-repo>/.claude/skills/
```
